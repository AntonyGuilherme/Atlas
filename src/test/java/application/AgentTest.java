...
public class AgentTest {
    ...
    public void shouldShuffleConsideringMultipleAgents() throws InterruptedException {
        ...
        while (!agent1.chanel.FINISHED.get() || !agent2.chanel.FINISHED.get() || !agent.chanel.FINISHED.get());

        System.out.printf("Agent r-%d e-%d\n",agent.chanel.wordsReceived.get(), agent.chanel.wordsExpected.get());
        System.out.printf("Agent r-%d e-%d\n",agent1.chanel.wordsReceived.get(), agent1.chanel.wordsExpected.get());
        System.out.printf("Agent r-%d e-%d\n",agent2.chanel.wordsReceived.get(), agent2.chanel.wordsExpected.get());


        Map<String, Long> words = new HashMap<>();

        // middle database romulus
    ...
    public void insertFrom(int agentId, Map<String, Long> words) throws InterruptedException {
        ReShuffleRockPersistence repository = new ReShuffleRockPersistence(agentId);
        repository.init();
    ...
    public void insertMFrom(int agentId, Map<String, Long> words) throws InterruptedException {
